 ...
 * Last Modified: Thursday, August 10th 2023, 5:05:29 am
...
import ErrorMessages from 'pages/auth/components/errorMessages'

function Auth() {
  const location = useLocation()
  const isLoginPath = location.pathname === '/login'
  const apiURL = isLoginPath ? '/users/login' : '/users'
  const pageName = isLoginPath ? 'Login' : 'Register'
        ...
        <div className="row">
          <div className="col-md-6 offset-md-3 col-xs-12">
            <div className="text-xs-center">
              ...
              {error && <ErrorMessages messages={error.errors} />}
